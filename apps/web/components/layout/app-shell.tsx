...
export function AppShell({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="min-h-screen text-zinc-100">
      <div className="mx-auto flex min-h-screen max-w-[1560px] p-4 xl:p-5">
        <aside className="w-72 rounded-2xl border border-slate-400/15 bg-[linear-gradient(180deg,rgba(19,28,43,0.9),rgba(10,16,27,0.96))] px-4 py-5 shadow-[inset_0_1px_0_rgba(255,255,255,0.05),inset_-1px_0_0_rgba(255,255,255,0.05),0_20px_48px_rgba(2,6,14,0.62)]">
            ...
            {nav.map((item) => {
              ...
              return (
                <Link
                  key={item.href}
                  href={item.href}
                  className={`group block rounded-lg border px-3.5 py-2.5 text-sm transition ${active
        ...
        <div className="ml-4 flex min-w-0 flex-1 flex-col overflow-hidden rounded-2xl border border-slate-300/10 bg-[linear-gradient(180deg,rgba(11,17,29,0.88),rgba(8,13,23,0.95))] shadow-[inset_0_1px_0_rgba(255,255,255,0.04),0_30px_70px_rgba(2,7,14,0.66)]">
